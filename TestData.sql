...
insert into moniterdata.事件记录(时间, IP地址, 设备型号, `SESSION编号`, 所在页面, 用户, 事件类型, 事件描述)
values
('2019-02-25 13:45','192.168.31.85','aaa',null,'yindaheng98.top/a','yin','注册完成',null),
('2019-02-23 16:25','192.168.31.85','aaa',null,'yindaheng98.top','yin','注册完成',null),
('2019-02-23 15:35','192.168.31.85','aaa',null,'yindaheng98.top','yin','注册完成',null),
('2019-01-25 14:45','192.168.31.85','aaa',null,'yindaheng98.top','yin','注册完成',null),
('2019-01-23 15:35','192.168.31.85','aaa',null,'yindaheng98.top','yin','注册完成',null),
('2019-01-25 14:45','192.168.31.85','aaa',null,'yindaheng98.top','yin','注册完成',null),
