...
public class Tools {
     ...
     * @return 返回连续的时间表
     */
    public static String[][] smoothTimeTable(String[][] timeTable, int dataNum, long time_dif, SimpleDateFormat df) {
        return smoothTimeTable(timeTable, dataNum, time_dif, df, null);
    }
     ...
     * @return 返回连续的时间表
     */
    public static String[][] smoothTimeTable(String[][] timeTable, int dataNum, long time_dif, SimpleDateFormat df, String fill) {
